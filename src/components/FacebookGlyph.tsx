...
/**
 * Standalone filled Facebook mark. Kept separate from Icon.tsx because that
 * set is stroke-based (currentColor outlines); the FB glyph reads correctly
 * only as a solid fill.
 */
export default function FacebookGlyph({ className = "w-5 h-5" }: FacebookGlyphProps) {
  return (
